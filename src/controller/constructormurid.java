 ...
 */
    ...
    ArrayList <String[]> arrayMurid = new ArrayList <>();
          public boolean create() {
            ...
            try{
                if (getNama().isEmpty() || getTanggalLahir().isEmpty() || getAlamat().isEmpty() || getNomorOrangTua().isEmpty() || getNamaOrangTua().isEmpty()) {
    ...
    public ArrayList<String[]> readMurid() throws SQLException {
        ...
        while (rs.next()) {            
            String idMurid = rs.getString("id_murid");
            ...
            String[] data = {idMurid, nama, tanggalLahir, alamat, namaOrangTua, nomorOrangTua};   
            arrayMurid.add(data);
        }return arrayMurid;
    }
